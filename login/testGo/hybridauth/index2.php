...
//session_start();
/*$config = [
    'callback' => 'https://test.librarylabs.ed.ac.uk/login/testG2/hybridauth/index.php', // or Hybridauth\HttpClient\Util::getCurrentUrl()
    'keys' => [ 'id' => '682814395284-uankisvij90jc6b7g78udvot1170v39s.apps.googleusercontent.com', 'secret' => 'vJiBxnxacNq-nT2gOjGMcfCS' ],// Your Github application credentials
    /* optional : set scope
        'scope' => 'user:email', */
 ...
 */
// $github = new Hybridauth\Provider\Google($config);
// /**
